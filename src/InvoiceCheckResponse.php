...
class InvoiceCheckResponse{
  protected $responseStatus;
  protected $onlyWinningInv = "";
  protected $details;

  function __construct($data){
    $this->responseStatus = new ResponseStatus($data);
    $this->onlyWinningInv = $data['onlyWinningInv'];
    foreach($data['details'] as $k => $v){
      $this->details[] = new InvoiceCheckResponseInvoiceItem($v);
    }
  }

  function isOnlyWinningInv(){return $this->onlyWinningInv === 'Y';}
